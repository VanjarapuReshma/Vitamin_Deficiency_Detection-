...
// };
const mapToPlannerKey = (deficiency) => {
    let cleanKey = deficiency.replace(/ deficiency/i, "").replace(/\s/g, "");
    const upperKey = cleanKey.toUpperCase();

    // Handle consolidated mineral groups
    if (upperKey.includes("IRON") || upperKey.includes("ZINC") || upperKey.includes("BIOTIN") || upperKey.includes("PROTEIN")) {
        return "Protein-Mineral"; 
    }
    
    // Returns clean key, e.g., "VitaminB1" or "VitaminA".
    return cleanKey;
};
