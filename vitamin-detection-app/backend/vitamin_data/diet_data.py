...
vitamin_diets = {
    ...
    "VitaminB9": {
        "fact": "Folate (B9) is crucial for DNA synthesis, cell division, and preventing neurological birth defects.",
    "rda": 400,  # µg (micrograms)
        "intake_percent": 60,
        "plan": [
            {"day":"Day 1","intake_percent":65,"meals":[
                {"type":"Breakfast","food":"Spinach and Eggs Scramble (3 eggs)","nutrients":"B9 35%","alternatives":["Fortified Cereal","Moong Dal Chilla"]},
                {"type":"Lunch","food":"Lentil Soup (Dal) with whole wheat bread","nutrients":"B9 25%","alternatives":["Chickpea Salad","Quinoa Vegetable Bowl"]},
                {"type":"Dinner","food":"Grilled Salmon with Asparagus","nutrients":"B9 15%","alternatives":["Steamed Broccoli","Tofu Curry"]}
            ]},
            {"day":"Day 2","intake_percent":70,"meals":[
                {"type":"Breakfast","food":"Avocado Toast on whole wheat","nutrients":"B9 30%","alternatives":["Oats with Berries","Almond Milk Smoothie"]},
                {"type":"Lunch","food":"Rajma (Kidney Beans) Masala with brown rice","nutrients":"B9 30%","alternatives":["Black Bean Burger","Lentil Pilaf"]},
                {"type":"Dinner","food":"Chicken Breast Stir-fry with bell peppers","nutrients":"B9 10%","alternatives":["Paneer Tikka","Tofu Stir-fry"]}
            ]},
            {"day":"Day 3","intake_percent":75,"meals":[
                {"type":"Breakfast","food":"Fortified Breakfast Cereal with milk","nutrients":"B9 35%","alternatives":["Yogurt Parfait","Whole Grain Pancakes"]},
                {"type":"Lunch","food":"Spinach and Cheese Sandwich","nutrients":"B9 30%","alternatives":["Mushroom Curry","Quinoa Salad"]},
                {"type":"Dinner","food":"Liver (Goat/Chicken) with steamed greens","nutrients":"B9 20%","alternatives":["Grilled Tofu","Vegetable Curry"]}
            ]},
            {"day":"Day 4","intake_percent":80,"meals":[
                {"type":"Breakfast","food":"Orange slices and yogurt","nutrients":"B9 25%","alternatives":["Banana Smoothie","Whole wheat muffin"]},
                {"type":"Lunch","food":"Black-eyed Peas Curry (Lobiya)","nutrients":"B9 40%","alternatives":["Lentil Soup","Brown Rice Pulao"]},
                {"type":"Dinner","food":"Mashed Potatoes with baked chicken","nutrients":"B9 15%","alternatives":["Grilled Paneer","Chickpea Burger"]}
            ]},
            {"day":"Day 5","intake_percent":85,"meals":[
                {"type":"Breakfast","food":"Whole grain bread with peanut butter","nutrients":"B9 25%","alternatives":["Oats","Sprouts Salad"]},
                {"type":"Lunch","food":"Chana Masala (Chickpea curry) and roti","nutrients":"B9 35%","alternatives":["Rajma","Mushroom Soup"]},
                {"type":"Dinner","food":"Chicken Stew with root vegetables","nutrients":"B9 25%","alternatives":["Fish Curry","Tofu Skewers"]}
            ]},
            {"day":"Day 6","intake_percent":90,"meals":[
                {"type":"Breakfast","food":"Sprouts salad with lemon","nutrients":"B9 30%","alternatives":["Fortified Cereal","Egg Bhurji"]},
                {"type":"Lunch","food":"Quinoa Vegetable Pulao","nutrients":"B9 35%","alternatives":["Lentil and Vegetable Curry","Brown Rice Bowl"]},
                {"type":"Dinner","food":"Grilled Fish (Tuna/Salmon) with rice","nutrients":"B9 25%","alternatives":["Paneer Korma","Vegetable Biryani"]}
            ]},
            {"day":"Day 7","intake_percent":100,"meals":[
                {"type":"Breakfast","food":"Oats cooked with Spinach and mushrooms","nutrients":"B9 40%","alternatives":["Avocado Toast","Whole Wheat Paratha"]},
                {"type":"Lunch","food":"Lentil and Vegetable Curry with rice","nutrients":"B9 35%","alternatives":["Chickpea and Spinach Salad","Quinoa Soup"]},
                {"type":"Dinner","food":"Grilled Chicken with mixed vegetables","nutrients":"B9 25%","alternatives":["Tofu Steaks","Lentil Khichdi"]}
            ]}
        ]
    },
